...
react hooks:
  special built in functions that allows us to hook into react internals:
    creating andaccessing state from fiber tree
    registering siide effects in fiber tree
    manual dom selection and many more

  Always start form "use"
  enable easy reusing of non visual logic:we can compose multiple hooks into our own custom hooks
  there are 20 built in hooks:
    useState
    useEffect
    useReducer
    useContext
    ...
    rules  of hooks:
      only call hooks at the top level
        do not call hooks iside coditions , loops ,  nested  functions
